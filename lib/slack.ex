defmodule Slack do
  ...
  * `handle_close(reason, slack, state)` - called when websocket is closed. Can return either `:close` to kill the process or `:reconnect` to attempt to reconnect without closing the process.
